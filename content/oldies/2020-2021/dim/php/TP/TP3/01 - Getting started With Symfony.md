...
> [!NOTE] Les blocs quote (ce bloc par exemple), sont des **questions à répondre** qui pourraient apparaître dans l'évaluation finale. 
...
> [!NOTE] Quelles sont les fonctionnalités principales du Symfony CLI ?
