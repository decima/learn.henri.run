---
title: Redis
description: Une base de données en mémoire clé-valeur.
cover: ../images/redis_cover.jpg
type: 1_courses
level: 2
---
...
Les sets sont des boîtes de valeurs uniques. On peut déposer une valeur, vérifier si une valeur est dans le SET, et en
...
Comme les sets, les Sets Ordonnés ne peuvent contenir que des valeurs uniques. La différence est que chaque valeurs peut
avoir un score qui donnera l'ordre de la liste. 2 valeurs peuvent avoir le même score.
...
- Dans quels cas peut-on utiliser Redis ?
  ...
  Tout ce qui demande de la **vitesse** 🏃‍♀️

---

> [!IMPORTANT] ⚠️ **Redis par défaut N´EST PAS ACID.**
